...
const PageFooter = () => {
    ...
    const openModal = (type: keyof typeof legalContent) => (e: React.MouseEvent) => {
        e.preventDefault();
        setActiveModal(type);
    };
    ...
    return (
        <footer className="bg-[#000000] text-gray-500 py-20 border-t border-white/10 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
                ...
                <div>
                    ...
                    <ul className="space-y-4 text-sm">
                        ...
                        <li>
                            <a href="#" onClick={openModal('privacy')} className="hover:text-white transition-colors duration-300">Privacy Policy</a>
                        </li>
                        <li>
                            <a href="#" onClick={openModal('terms')} className="hover:text-white transition-colors duration-300">Terms of Service</a>
                        </li>
                        <li>
                            <a href="#" onClick={openModal('disclaimer')} className="hover:text-white transition-colors duration-300">Disclaimer</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <LegalModal
                ...
                content={activeModal ? legalContent[activeModal].content : null}
            />
        </footer >
    );
};
